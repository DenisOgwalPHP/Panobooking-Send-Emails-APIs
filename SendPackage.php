...
$to = test_input(trim($_GET['packageemail']));
$booknotes =test_input($_GET['bookingnotes']);
$messsage = "Our Esteemed Partner, Your Package was chosen by our Clients Community and you are kindly requested to check your Panobooking Dashboard to confirm this order. Thank you for working with us. or Reach out to 0741822377 for further details";

require_once('connect.php');
$sales6 ="SELECT TelephoneNumber FROM `tourpackage` where EmailAddress='".$to."'";
...
$message .='<div style="padding:10px;text-align:center"><a href="https://tourpackages.panobooking.com/"><button style="padding:10px;text-align:center;height:50px;border-radius: 10px;background-color:#3383ff; color:white;font-size:20px;">Confirm Booking</button></a></div></div>';
$message .= '</body></html>';
