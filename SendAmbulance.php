...
$message .='<div style="padding:10px;text-align:center"><a href="https://ambulance.panobooking.com/"><button style="padding:10px;text-align:center;height:50px;border-radius: 10px;background-color:#3383ff; color:white;font-size:20px;">Confirm Order</button></a></div></div>';
$message .= '</body></html>';
