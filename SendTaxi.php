...
$messsage = "Esteemed Service Provider, We wish to inform you that an order for pickup has been placed by our Clients Community. Please check your Panobooking Dashboard to confirm. or Reach out to 0741822377 for further details";

require_once('connect.php');
$sales6 ="SELECT TelephoneNumber FROM `airporttaxi` where EmailAddress='".$to."'";
